...
"""
    ...
    This module just stores the rater settings.
...
# propagate early.  That way we can import "from rater import settings"
...
import sys, rater
rater.settings = sys.modules['rater.settings']
del sys, rater
...
def autodiscover_settings():
    ...
    import os
    if 'rater_SETTINGS_FILE' in os.environ:
        configure_from_file(os.environ['rater_SETTINGS_FILE'])
